...
export default function TestimonialCard({ name, role, content }: TestimonialCardProps) {
  return (
    <div className="motion-rise motion-card bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg hover:border-[var(--bokana-amber)]/30 relative">
