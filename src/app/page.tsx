...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="motion-fade md:hidden relative w-full h-[100dvh] overflow-hidden flex flex-col items-center justify-center bg-gradient-to-br from-[var(--foreground)] via-slate-900 to-black">
        <div className="absolute inset-0 bg-black/20 backdrop-blur-3xl z-0" />
        <div className="motion-rise relative z-10 text-center px-4 mt-[-5dvh]">
        ...
        <div className="motion-fade motion-delay-1 absolute bottom-0 w-[120%] h-[55%] z-0 translate-y-4">
          <MobileHeroImage />
        </div>
      </section>

      {/* Mobile CTA Buttons (Immediately below the 100dvh viewport) */}
      <section className="motion-rise md:hidden w-full bg-[var(--background)] px-4 py-6 flex justify-center gap-3 border-b border-gray-100">
      ...
      <section className="motion-fade hidden md:block relative bg-[var(--background)] pt-20 pb-32 overflow-hidden">
      ...
      {/* Trust Badges */}
      <section className="motion-rise py-12 bg-white border-y border-gray-100">
      ...
      <section className="motion-fade py-24 bg-[var(--foreground)] text-white relative overflow-hidden">
        ...
        <div className="motion-rise max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
      ...
      {/* Final CTA */}
      <section className="motion-fade py-24 bg-gradient-to-r from-[var(--bokana-slate)] to-[var(--bokana-amber)] text-white text-center">
